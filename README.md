...
<head>
  ...
  <!-- PretendardVariable 웹폰트 로드 (버전 고정) -->
  <link
    rel="stylesheet"
    href="https://cdn.jsdelivr.net/npm/pretendard@1.3.8/dist/web/static/variable/pretendardvariable.css"
  />

  <style>
    /* ──────────────────────────────────────
       font-family에 PretendardVariable + 시스템 한글 폰트 추가
       ────────────────────────────────────── */
    body, h1 {
      font-family:
        'PretendardVariable',
    ...
    body {
      padding: 20px;
      background: url('https://i.imgur.com/ggotSIY.jpeg') no-repeat center / cover, #e0f7fa;
      color: #333;
    }
    h1 {
      max-width: 700px;
